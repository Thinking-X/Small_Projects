<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="NewsPublishSystem._default" %>
        ...
        <script type="text/javascript">
            $(function () {
                $("#btnSearch").click(function () {                   
                    location.href = "SearchResult.aspx?Keyword=" + $("#exampleInputAmount").val();
