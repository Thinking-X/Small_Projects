...
namespace SMarketProj.PublicClass
{
    class CreateBill
    {
        ...
        /// 散客消费
        /// </summary>
        public void SkConsume(SaleDetail sale, string total, string status)
        {
            string billInfo = "{\"shopName\":\"大润发-玛特 超市\",\"cardNumber\":\""+ sale.MemNum +"\",\"customer\":\"顾客\",\"productName\":\"商品名\",\"number\":\"1\",\"price\":\"3\",\"total\":\"3\",\"totalPrice\":\""+ total + "\",\"operation\":\"\",\"oddNumber\":\""+ sale.SaleTabNum + "\",\"telephone\":\"0531-67818167\",\"staff\":\""+ status + "\",\"address\":\"二环东路发展大厦B座16A\",\"remark\":\"-------------\",\"payMethods\":[{\"payMethod\":\"\",\"price\":\""+ sale.SaleTotal + "\"},{\"payMethod\":\"\",\"price\":\""+ sale.SaleTotal + "\"}],\"storedMoney\":\"100\",\"giveMoney\":\"20\"}"; 
        ...
        private void SkPrintDocument_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("商品", new Font(new FontFamily("黑体"), 8), System.Drawing.Brushes.Black, 0, 72);
