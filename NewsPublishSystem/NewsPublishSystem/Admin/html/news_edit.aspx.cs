...
namespace NewsPublishSystem.Admin.html
{
    public partial class news_edit : System.Web.UI.Page
    {
        ...
        //{
        //    HtmlButton RadioAccept = (HtmlButton)Page.FindControl("radioAccept");
        //    if (IsPostBack)
        //    { newsTitle = e.CommandArgument.ToString(); }
        //    string id = e.CommandArgument.ToString();

        //    NewsBLL nb = new NewsBLL();
        //    Hashtable hashtable = new Hashtable();
        //    hashtable.Add("@NewsID", e.CommandArgument.ToString().Trim());
        //    if (nb.DeleteRecord(hashtable))
        //    {
        //        Page.ClientScript.RegisterStartupScript(GetType(), "message", "<script>alert('已成功删除')</script>");
        //    }
        //    else
        //    {
